...
1. **Tela inicial** — exibe o embed "Heaven's Market" com **2 botões**:
   - **💎 Comprar Robux!**
   - **🎮 Comprar Gamepass!**
2. **Clique em qualquer botão** — o bot cria um **canal de ticket** imediatamente na categoria configurada, posta os termos de uso dentro do ticket com o botão **📝 Inserir Nickname do Roblox**, e envia uma confirmação **ephemeral** (visível só para quem clicou) com o link para o ticket. A mensagem original do `/loja` **permanece intacta** com os botões, podendo ser usada por outros usuários.
